...
static int G28(void){
	//stepper_move(0,1000*16*240);
	//while(stepper_isbusy(0)) osDelay(2);
...
static int G0(int isx,int x,int isy,int y){
	...
	if(use_move_d){
		...
		if(isx==1 && isy==0) xy_move(x,oy,oz);
